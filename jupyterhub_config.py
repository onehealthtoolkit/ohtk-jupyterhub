    ...
    def __init__(self, *arg, **kwargs):
        ...
        for authenticator_klass, url_scope, configs in self.authenticators:
            ...
            self._authenticators.append(
                {"instance": authenticator_klass(**c), "url_scope": url_scope}
            )
...
#  Default: '/Users/pphetra/.pyenv/versions/jupyter/share/jupyterhub'
# c.JupyterHub.data_files_path = '/Users/pphetra/.pyenv/versions/jupyter/share/jupyterhub'
...
#  .. versionadded:: 0.9
#  Default: ''
c.JupyterHub.hub_bind_url = "http://192.168.1.102:8081"
...
#  Default: None
c.Spawner.hub_connect_url = "http://192.168.1.102:8081"
...
#     "http://192.168.1.102:8888/hub/oauth_callback"
# )
# c.GenericOAuthenticator.client_id = "dCipgip8oPofpBNBy9mSKe8wei9pfrMdacXYU8eK"
# c.GenericOAuthenticator.client_secret = "test"
# c.GenericOAuthenticator.login_service = "ohtk"
# c.GenericOAuthenticator.userdata_url = "https://bunny.opensur.test/api/userinfo/"
# c.GenericOAuthenticator.token_url = "https://bunny.opensur.test/o/token/"
# c.GenericOAuthenticator.authorize_url = "https://bunny.opensur.test/o/authorize/"
